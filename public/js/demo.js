...
(function (root, factory) {
  if (typeof exports === 'object') {
    ...
    // AMD
    define([], function () {
      return root.OrbitControls = factory();
    });
  } else {
    // Global Variables
    root.OrbitControls = factory();
  }
}(this, function () {
  'use strict';
...
var _OrbitControls = require('threejs-controls/OrbitControls');
...
var App = function () {
  ...
  _createClass(App, [{
    ...
    value: function complete(file) {
      ...
      setTimeout(function () {
        _this3.firstRing = new THREE.Object3D();
        _this3.secondRing = new THREE.Object3D();
        _this3.thirdRing = new THREE.Object3D();
        _this3.fourthRing = new THREE.Object3D();

        _this3.setupAudio();
        _this3.addSoundControls();
        _this3.createScene();
        _this3.createCamera();
        _this3.addAmbientLight();
        _this3.addSpotLight();

        _this3.addCameraControls();
        _this3.addFloor();

        _this3.createRingOfSquares(20, 1, 0x4250ca, _this3.firstRing);
        _this3.createRingOfSquares(30, 2, 0x721fa1, _this3.secondRing);
        _this3.createRingOfSquares(40, 3, 0xf95c38, _this3.thirdRing);
        _this3.createRingOfSquares(50, 4, 0x5e0f86, _this3.fourthRing);
    ...
    value: function addSoundControls() {
      ...
      this.btnPlay.addEventListener('click', function () {
        ...
        _this4.btnPlay.classList.remove('control-show');
        _this4.btnPause.classList.add('control-show');
      });

      this.btnPause.addEventListener('click', function () {
        _this4.audioElement.pause();
        _this4.btnPause.classList.remove('control-show');
        _this4.btnPlay.classList.add('control-show');
      });
    }
  }, {
    ...
    value: function playSound(file) {
      ...
      setTimeout(function () {
        _this6.audioElement.src = file;
        _this6.audioElement.load();
        _this6.audioElement.play();
