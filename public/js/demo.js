  ...
  _createClass(App, [{
    ...
    value: function complete(file) {
      ...
      setTimeout(function () {
        ...
        _this3.addFloor();
        _this3.createRingOfSquares(20, 1, 0x4250ca);
        _this3.createRingOfSquares(30, 2, 0x721fa1);
        _this3.createRingOfSquares(40, 3, 0xf95c38);
        _this3.createRingOfSquares(50, 4, 0x5e0f86);
        _this3.animate();
    ...
    value: function createRingOfSquares(count, radius, color) {
    ...
    value: function playSound(file) {
      ...
      setTimeout(function () {
        _this4.audioElement.src = file;
        _this4.audioElement.load();
