...
var _TransformControls = require('threejs-controls/TransformControls');
...
var App = function () {
  ...
  _createClass(App, [{
      ...
      if (percent === 100) {
        setTimeout(function () {
          requestAnimationFrame(function () {
            _this.loaderBar.classList.add('removeLoader');
            _this.loaderBar.style.transform = 'scale(1, 0)';
          });
        }, 300);
      }
    }
    ...
    value: function createObj() {
      ...
      this.control = new _TransformControls2.default(this.camera, this.renderer.domElement);
...
},{"./loader":5,"gsap":1,"threejs-controls/OrbitControls":2,"threejs-controls/TransformControls":3}],5:[function(require,module,exports){
'use strict';
